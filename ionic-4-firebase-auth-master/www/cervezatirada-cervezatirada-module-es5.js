...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cervezatirada-cervezatirada-module"], {
  ...
  /***/
  function srcAppCervezatiradaCervezatiradaRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CervezatiradaPageRoutingModule", function () {
      return CervezatiradaPageRoutingModule;
    });
    /* harmony import */
    ...
    var _cervezatirada_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./cervezatirada.page */
    ...
    var CervezatiradaPageRoutingModule = function CervezatiradaPageRoutingModule() {
      _classCallCheck(this, CervezatiradaPageRoutingModule);
    };

    CervezatiradaPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: CervezatiradaPageRoutingModule
    });
    CervezatiradaPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function CervezatiradaPageRoutingModule_Factory(t) {
        return new (t || CervezatiradaPageRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CervezatiradaPageRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CervezatiradaPageRoutingModule, [{
  ...
  /***/
  function srcAppCervezatiradaCervezatiradaModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CervezatiradaPageModule", function () {
      return CervezatiradaPageModule;
    });
    /* harmony import */
    ...
    var _cervezatirada_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./cervezatirada-routing.module */
    "./src/app/cervezatirada/cervezatirada-routing.module.ts");
    /* harmony import */


    var _cervezatirada_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./cervezatirada.page */
    "./src/app/cervezatirada/cervezatirada.page.ts");

    var CervezatiradaPageModule = function CervezatiradaPageModule() {
      _classCallCheck(this, CervezatiradaPageModule);
    };

    CervezatiradaPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: CervezatiradaPageModule
    });
    CervezatiradaPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function CervezatiradaPageModule_Factory(t) {
        return new (t || CervezatiradaPageModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _cervezatirada_routing_module__WEBPACK_IMPORTED_MODULE_4__["CervezatiradaPageRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CervezatiradaPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CervezatiradaPageModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _cervezatirada_routing_module__WEBPACK_IMPORTED_MODULE_4__["CervezatiradaPageRoutingModule"]],
          declarations: [_cervezatirada_page__WEBPACK_IMPORTED_MODULE_5__["CervezatiradaPage"]]
  ...
  /***/
  function srcAppCervezatiradaCervezatiradaPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CervezatiradaPage", function () {
      return CervezatiradaPage;
    });
    /* harmony import */
    ...
    function CervezatiradaPage_ion_slide_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CervezatiradaPage =
    /*#__PURE__*/
    function () {
      function CervezatiradaPage() {
        _classCallCheck(this, CervezatiradaPage);
      ...
      _createClass(CervezatiradaPage, [{
        key: "ngOnInit",
    ...
    CervezatiradaPage.ɵfac = function CervezatiradaPage_Factory(t) {
      return new (t || CervezatiradaPage)();
    };

    CervezatiradaPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CervezatiradaPage,
      selectors: [["app-cervezatirada"]],
      viewQuery: function CervezatiradaPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function CervezatiradaPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CervezatiradaPage_Template_span_click_8_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r32);

            var _r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

            return ctx.slidePrev(ctx.sliderOne, _r29);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionSlideDidChange", function CervezatiradaPage_Template_ion_slides_ionSlideDidChange_11_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r32);

            var _r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

            return ctx.SlideDidChange(ctx.sliderOne, _r29);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CervezatiradaPage_Template_span_click_15_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r32);

            var _r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

            return ctx.slideNext(ctx.sliderOne, _r29);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CervezatiradaPage, [{
...
//# sourceMappingURL=cervezatirada-cervezatirada-module-es5.js.map