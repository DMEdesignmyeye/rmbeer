...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["espumantes-espumantes-module"], {
  ...
  /***/
  function srcAppEspumantesEspumantesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EspumantesPageRoutingModule", function () {
      return EspumantesPageRoutingModule;
    });
    /* harmony import */
    ...
    var _espumantes_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./espumantes.page */
    ...
    var EspumantesPageRoutingModule = function EspumantesPageRoutingModule() {
      _classCallCheck(this, EspumantesPageRoutingModule);
    };

    EspumantesPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: EspumantesPageRoutingModule
    });
    EspumantesPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function EspumantesPageRoutingModule_Factory(t) {
        return new (t || EspumantesPageRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](EspumantesPageRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EspumantesPageRoutingModule, [{
  ...
  /***/
  function srcAppEspumantesEspumantesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EspumantesPageModule", function () {
      return EspumantesPageModule;
    });
    /* harmony import */
    ...
    var _espumantes_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./espumantes-routing.module */
    "./src/app/espumantes/espumantes-routing.module.ts");
    /* harmony import */


    var _espumantes_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./espumantes.page */
    "./src/app/espumantes/espumantes.page.ts");

    var EspumantesPageModule = function EspumantesPageModule() {
      _classCallCheck(this, EspumantesPageModule);
    };

    EspumantesPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: EspumantesPageModule
    });
    EspumantesPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function EspumantesPageModule_Factory(t) {
        return new (t || EspumantesPageModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _espumantes_routing_module__WEBPACK_IMPORTED_MODULE_4__["EspumantesPageRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](EspumantesPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EspumantesPageModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _espumantes_routing_module__WEBPACK_IMPORTED_MODULE_4__["EspumantesPageRoutingModule"]],
          declarations: [_espumantes_page__WEBPACK_IMPORTED_MODULE_5__["EspumantesPage"]]
  ...
  /***/
  function srcAppEspumantesEspumantesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EspumantesPage", function () {
      return EspumantesPage;
    });
    /* harmony import */
    ...
    function EspumantesPage_ion_slide_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function EspumantesPage() {
        _classCallCheck(this, EspumantesPage);
    ...
    EspumantesPage.ɵfac = function EspumantesPage_Factory(t) {
      return new (t || EspumantesPage)();
    };

    EspumantesPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EspumantesPage,
      selectors: [["app-espumantes"]],
      viewQuery: function EspumantesPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 38,
      vars: 6,
      consts: [["fullscreen", ""], [2, "color", "white !important", "font-size", "18px"], ["size", "8"], [1, "slider-nav", "arrow-prev", 3, "click"], [1, "prev-icon-custom", "custon-nav"], ["size", "16"], ["pager", "true", 3, "options", "ionSlideDidChange"], ["slideWithNav", ""], [4, "ngFor", "ngForOf"], [1, "slider-nav", "arrow-next", 3, "click"], [1, "next-icon-custom", "custon-nav"], [2, "color", "white !important", "font-size", "16px"], ["slot", "start"], ["src", "../../assets/img/menu/chan/1.jpg"], [2, "color", "white !important"], [3, "src"]],
      template: function EspumantesPage_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EspumantesPage_Template_span_click_8_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r48);

            var _r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

            return ctx.slidePrev(ctx.sliderOne, _r45);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ionSlideDidChange", function EspumantesPage_Template_ion_slides_ionSlideDidChange_11_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r48);

            var _r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

            return ctx.SlideDidChange(ctx.sliderOne, _r45);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EspumantesPage_Template_span_click_15_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r48);

            var _r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](12);

            return ctx.slideNext(ctx.sliderOne, _r45);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EspumantesPage, [{
...
//# sourceMappingURL=espumantes-espumantes-module-es5.js.map