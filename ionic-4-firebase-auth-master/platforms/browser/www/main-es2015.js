...
const routes = [
    ...
    { path: 'signup', loadChildren: () => __webpack_require__.e(/*! import() | signup-signup-module */ "signup-signup-module").then(__webpack_require__.bind(null, /*! ./signup/signup.module */ "./src/app/signup/signup.module.ts")).then(m => m.SignupPageModule) },
    { path: 'forgot', loadChildren: () => __webpack_require__.e(/*! import() | forgot-forgot-module */ "forgot-forgot-module").then(__webpack_require__.bind(null, /*! ./forgot/forgot.module */ "./src/app/forgot/forgot.module.ts")).then(m => m.ForgotPageModule) },
    ...
    {
        path: 'qrscann',
        loadChildren: () => __webpack_require__.e(/*! import() | qrscann-qrscann-module */ "qrscann-qrscann-module").then(__webpack_require__.bind(null, /*! ./qrscann/qrscann.module */ "./src/app/qrscann/qrscann.module.ts")).then(m => m.QrscannPageModule)
    },
    {
        path: 'gallery',
    ...
    {
        path: 'agenda',
        loadChildren: () => __webpack_require__.e(/*! import() | agenda-agenda-module */ "agenda-agenda-module").then(__webpack_require__.bind(null, /*! ./agenda/agenda.module */ "./src/app/agenda/agenda.module.ts")).then(m => m.AgendaPageModule)
    }, {
        path: 'form',
    ...
    {
        path: 'beneficiouno',
        loadChildren: () => __webpack_require__.e(/*! import() | beneficiouno-beneficiouno-module */ "beneficiouno-beneficiouno-module").then(__webpack_require__.bind(null, /*! ./beneficiouno/beneficiouno.module */ "./src/app/beneficiouno/beneficiouno.module.ts")).then(m => m.BeneficiounoPageModule)
    },
    {
        path: 'rabas',
        loadChildren: () => __webpack_require__.e(/*! import() | rabas-rabas-module */ "rabas-rabas-module").then(__webpack_require__.bind(null, /*! ./rabas/rabas.module */ "./src/app/rabas/rabas.module.ts")).then(m => m.RabasPageModule)
    },
    {
        path: 'entradas',
        loadChildren: () => __webpack_require__.e(/*! import() | entradas-entradas-module */ "entradas-entradas-module").then(__webpack_require__.bind(null, /*! ./entradas/entradas.module */ "./src/app/entradas/entradas.module.ts")).then(m => m.EntradasPageModule)
    },
    {
        path: 'tablas',
        loadChildren: () => __webpack_require__.e(/*! import() | tablas-tablas-module */ "tablas-tablas-module").then(__webpack_require__.bind(null, /*! ./tablas/tablas.module */ "./src/app/tablas/tablas.module.ts")).then(m => m.TablasPageModule)
    },
    {
        path: 'platos',
        loadChildren: () => __webpack_require__.e(/*! import() | platos-platos-module */ "platos-platos-module").then(__webpack_require__.bind(null, /*! ./platos/platos.module */ "./src/app/platos/platos.module.ts")).then(m => m.PlatosPageModule)
    },
    {
        path: 'pastas',
        loadChildren: () => __webpack_require__.e(/*! import() | pastas-pastas-module */ "pastas-pastas-module").then(__webpack_require__.bind(null, /*! ./pastas/pastas.module */ "./src/app/pastas/pastas.module.ts")).then(m => m.PastasPageModule)
    },
    {
        path: 'minuta',
        loadChildren: () => __webpack_require__.e(/*! import() | minuta-minuta-module */ "minuta-minuta-module").then(__webpack_require__.bind(null, /*! ./minuta/minuta.module */ "./src/app/minuta/minuta.module.ts")).then(m => m.MinutaPageModule)
    },
    {
        path: 'pizzas',
        loadChildren: () => __webpack_require__.e(/*! import() | pizzas-pizzas-module */ "pizzas-pizzas-module").then(__webpack_require__.bind(null, /*! ./pizzas/pizzas.module */ "./src/app/pizzas/pizzas.module.ts")).then(m => m.PizzasPageModule)
    },
    {
        path: 'burger',
        loadChildren: () => __webpack_require__.e(/*! import() | burger-burger-module */ "burger-burger-module").then(__webpack_require__.bind(null, /*! ./burger/burger.module */ "./src/app/burger/burger.module.ts")).then(m => m.BurgerPageModule)
    },
    {
        path: 'lomos',
        loadChildren: () => __webpack_require__.e(/*! import() | lomos-lomos-module */ "lomos-lomos-module").then(__webpack_require__.bind(null, /*! ./lomos/lomos.module */ "./src/app/lomos/lomos.module.ts")).then(m => m.LomosPageModule)
    },
    {
        path: 'parrilla',
        loadChildren: () => __webpack_require__.e(/*! import() | parrilla-parrilla-module */ "parrilla-parrilla-module").then(__webpack_require__.bind(null, /*! ./parrilla/parrilla.module */ "./src/app/parrilla/parrilla.module.ts")).then(m => m.ParrillaPageModule)
    },
    {
        path: 'tacos',
        loadChildren: () => __webpack_require__.e(/*! import() | tacos-tacos-module */ "tacos-tacos-module").then(__webpack_require__.bind(null, /*! ./tacos/tacos.module */ "./src/app/tacos/tacos.module.ts")).then(m => m.TacosPageModule)
    },
    {
        path: 'fajitas',
        loadChildren: () => __webpack_require__.e(/*! import() | fajitas-fajitas-module */ "fajitas-fajitas-module").then(__webpack_require__.bind(null, /*! ./fajitas/fajitas.module */ "./src/app/fajitas/fajitas.module.ts")).then(m => m.FajitasPageModule)
    },
    {
        path: 'fchicken',
        loadChildren: () => __webpack_require__.e(/*! import() | fchicken-fchicken-module */ "fchicken-fchicken-module").then(__webpack_require__.bind(null, /*! ./fchicken/fchicken.module */ "./src/app/fchicken/fchicken.module.ts")).then(m => m.FchickenPageModule)
    },
    {
        path: 'sandwichs',
        loadChildren: () => __webpack_require__.e(/*! import() | sandwichs-sandwichs-module */ "sandwichs-sandwichs-module").then(__webpack_require__.bind(null, /*! ./sandwichs/sandwichs.module */ "./src/app/sandwichs/sandwichs.module.ts")).then(m => m.SandwichsPageModule)
    },
    {
        path: 'ensaladas',
        loadChildren: () => __webpack_require__.e(/*! import() | ensaladas-ensaladas-module */ "ensaladas-ensaladas-module").then(__webpack_require__.bind(null, /*! ./ensaladas/ensaladas.module */ "./src/app/ensaladas/ensaladas.module.ts")).then(m => m.EnsaladasPageModule)
    },
    {
        path: 'rkids',
        loadChildren: () => __webpack_require__.e(/*! import() | rkids-rkids-module */ "rkids-rkids-module").then(__webpack_require__.bind(null, /*! ./rkids/rkids.module */ "./src/app/rkids/rkids.module.ts")).then(m => m.RkidsPageModule)
    },
    {
        path: 'postres',
        loadChildren: () => __webpack_require__.e(/*! import() | postres-postres-module */ "postres-postres-module").then(__webpack_require__.bind(null, /*! ./postres/postres.module */ "./src/app/postres/postres.module.ts")).then(m => m.PostresPageModule)
    },
    {
        path: 'misilestank',
        loadChildren: () => __webpack_require__.e(/*! import() | misilestank-misilestank-module */ "misilestank-misilestank-module").then(__webpack_require__.bind(null, /*! ./misilestank/misilestank.module */ "./src/app/misilestank/misilestank.module.ts")).then(m => m.MisilestankPageModule)
    },
    {
        path: 'cervezatirada',
        loadChildren: () => __webpack_require__.e(/*! import() | cervezatirada-cervezatirada-module */ "cervezatirada-cervezatirada-module").then(__webpack_require__.bind(null, /*! ./cervezatirada/cervezatirada.module */ "./src/app/cervezatirada/cervezatirada.module.ts")).then(m => m.CervezatiradaPageModule)
    },
    {
        path: 'superbalon',
        loadChildren: () => __webpack_require__.e(/*! import() | superbalon-superbalon-module */ "superbalon-superbalon-module").then(__webpack_require__.bind(null, /*! ./superbalon/superbalon.module */ "./src/app/superbalon/superbalon.module.ts")).then(m => m.SuperbalonPageModule)
    },
    {
        path: 'cocteleria',
        loadChildren: () => __webpack_require__.e(/*! import() | cocteleria-cocteleria-module */ "cocteleria-cocteleria-module").then(__webpack_require__.bind(null, /*! ./cocteleria/cocteleria.module */ "./src/app/cocteleria/cocteleria.module.ts")).then(m => m.CocteleriaPageModule)
    },
    {
        path: 'deautor',
        loadChildren: () => __webpack_require__.e(/*! import() | deautor-deautor-module */ "deautor-deautor-module").then(__webpack_require__.bind(null, /*! ./deautor/deautor.module */ "./src/app/deautor/deautor.module.ts")).then(m => m.DeautorPageModule)
    },
    {
        path: 'csabor',
        loadChildren: () => __webpack_require__.e(/*! import() | csabor-csabor-module */ "csabor-csabor-module").then(__webpack_require__.bind(null, /*! ./csabor/csabor.module */ "./src/app/csabor/csabor.module.ts")).then(m => m.CsaborPageModule)
    },
    {
        path: 'gintonic',
        loadChildren: () => __webpack_require__.e(/*! import() | gintonic-gintonic-module */ "gintonic-gintonic-module").then(__webpack_require__.bind(null, /*! ./gintonic/gintonic.module */ "./src/app/gintonic/gintonic.module.ts")).then(m => m.GintonicPageModule)
    },
    {
        path: 'whiskys',
        loadChildren: () => __webpack_require__.e(/*! import() | whiskys-whiskys-module */ "whiskys-whiskys-module").then(__webpack_require__.bind(null, /*! ./whiskys/whiskys.module */ "./src/app/whiskys/whiskys.module.ts")).then(m => m.WhiskysPageModule)
    },
    {
        path: 'espirituosos',
        loadChildren: () => __webpack_require__.e(/*! import() | espirituosos-espirituosos-module */ "espirituosos-espirituosos-module").then(__webpack_require__.bind(null, /*! ./espirituosos/espirituosos.module */ "./src/app/espirituosos/espirituosos.module.ts")).then(m => m.EspirituososPageModule)
    },
    {
        path: 'energizantes',
        loadChildren: () => __webpack_require__.e(/*! import() | energizantes-energizantes-module */ "energizantes-energizantes-module").then(__webpack_require__.bind(null, /*! ./energizantes/energizantes.module */ "./src/app/energizantes/energizantes.module.ts")).then(m => m.EnergizantesPageModule)
    },
    {
        path: 'espumantes',
        loadChildren: () => __webpack_require__.e(/*! import() | espumantes-espumantes-module */ "espumantes-espumantes-module").then(__webpack_require__.bind(null, /*! ./espumantes/espumantes.module */ "./src/app/espumantes/espumantes.module.ts")).then(m => m.EspumantesPageModule)
    },
    {
        path: 'other',
        loadChildren: () => __webpack_require__.e(/*! import() | other-other-module */ "other-other-module").then(__webpack_require__.bind(null, /*! ./other/other.module */ "./src/app/other/other.module.ts")).then(m => m.OtherPageModule)
    },
    {
        path: 'profile',
...
function AppComponent_ion_item_18_Template(rf, ctx) { if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-item", 26);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_ion_item_18_Template_ion_item_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.goTo(); });
...
function AppComponent_ion_item_26_Template(rf, ctx) { if (rf & 1) {
    const _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-item", 26);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_ion_item_26_Template_ion_item_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.goTo2(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class AppComponent {
    constructor(platform, splashScreen, statusBar, menu, data, router) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 40, vars: 4, consts: [["slot", "start", 2, "color", "white !important"], [3, "click"], ["text-center", "", 2, "background-color", "black", "color", "white !important", "font-weight", "bold"], ["name", "arrow-round-back"], ["name", "arrow-round-forward"], ["slot", "end", 2, "color", "white !important"], ["side", "start", "menuId", "first"], ["color", "danger"], [2, "color", "white"], ["placeholder", "Buscar", 2, "color", "white", 3, "ngModel", "ngModelChange", "ionInput"], ["style", "color: white !important", "routerDirection", "forward", 3, "routerLink", "click", 4, "ngFor", "ngForOf"], ["side", "end", "menuId", "end"], ["color", "primary"], ["placeholder", "Buscar", 3, "ngModel", "ngModelChange", "ionInput"], ["main", ""], ["slot", "bottom"], ["tab", "home"], ["name", "home"], ["tab", "agenda"], ["name", "calendar"], ["tab", "gallery"], ["name", "images"], ["tab", "qrscann"], ["name", "qr-scanner"], ["tab", "login"], ["name", "person"], ["routerDirection", "forward", 2, "color", "white !important", 3, "routerLink", "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_ion_menu_button_click_4_listener($event) { return ctx.openFirst(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, " Men\u00FA ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_ion_menu_button_click_10_listener($event) { return ctx.openEnd(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_ion_searchbar_ngModelChange_16_listener($event) { return ctx.searchTerm = $event; })("ionInput", function AppComponent_Template_ion_searchbar_ionInput_16_listener($event) { return ctx.setFilteredItems(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_ion_searchbar_ngModelChange_24_listener($event) { return ctx.searchTerm2 = $event; })("ionInput", function AppComponent_Template_ion_searchbar_ionInput_24_listener($event) { return ctx.setFilteredItems2(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"] }, { type: _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"] }, { type: _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["MenuController"] }, { type: _home_service__WEBPACK_IMPORTED_MODULE_2__["Data"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }]; }, null); })();
...
/* harmony import */ var _home_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./home.service */ "./src/app/home.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        ...
        _home_service__WEBPACK_IMPORTED_MODULE_9__["Data"]
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_14__["environment"].config),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_11__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_13__["AngularFireAuthModule"]] }); })();
...
Data.ɵfac = function Data_Factory(t) { return new (t || Data)(); };
Data.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: Data, factory: Data.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Data, [{
...
module.exports = __webpack_require__(/*! C:\Users\Nicolas\Documents\rmb\ionic-4-firebase-auth-master\src\main.ts */"./src/main.ts");
